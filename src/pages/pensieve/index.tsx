...
import { copyContentAssets, getPosts } from '@lib/content';
...
const PensievePage = ({ posts }: PensieveProps) => (
  <>
    <Head title="Pensieve" />
...
export const getStaticProps: GetStaticProps<PensieveProps> = async () => {
  copyContentAssets();
